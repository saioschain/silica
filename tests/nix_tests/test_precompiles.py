...
def test_ibc_transfer(ibc):
    ...
    pc = get_precompile_contract(ibc.chains["sai"].w3, "ICS20I")
    evmos_gas_price = ibc.chains["sai"].w3.eth.gas_price
    ...
    receipt = ibc.chains["sai"].w3.eth.wait_for_transaction_receipt(tx_hash)
